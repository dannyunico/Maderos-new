			...
			<div class="content-about">
				...
				<div class="items-about">
					<ul>
						...
						<li class="wow fadeInUp" data-wow-delay='0.2s'><img src="<?php echo get_template_directory_uri();?>/assets/img/bbq1.png" alt="">Solarium con Zona BBQ</li>
						...
						<li class="wow fadeInUp" data-wow-delay='0.8s'><img src="<?php echo get_template_directory_uri();?>/assets/img/Jacuzzi-con-hidromasajes (1).png" alt=""> Jacuzzi con hidromasajes</li>
