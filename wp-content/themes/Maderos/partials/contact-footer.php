        ...
        <div class="content-contact">
          <div class="row">
            <div class="col-md-12 form__item--contact--bg">
              ...
              <div>
                <form method="POST" action="https://nivel.activehosted.com/proc.php" id="_form_17_" class="_form _form_17 _inline-form  _dark" novalidate>
                  ...
                  <div class="_form-content">
                    ...
                    <!-- utm_group -->
                    <input type="hidden" name="field[16]" value="<?php echo $_GET['utm_group']; ?>" />
                    <!-- utm_content -->
                    <input type="hidden" name="field[15]" value="<?php echo $_GET['utm_content']; ?>" />
                    <!-- utm_term -->
                    ...
                    <div class="_form_element _field2 _full_width " >
                      ...
                      <div class="_field-wrapper">
                        <textarea name="field[2]" placeholder="Mensaje"  ></textarea>
                      </div>
                    </div>
                    <div class="_form_element _field4 _full_width " id="check-footer" >
                      <div class="_row">
                        <label class="_form-label">
                      ...
                      <div class="_row _checkbox-radio">
                        <input style="width: auto;" id="field_4Acepto" type="checkbox" name="field[4][]" value="Acepto"   >
                        <span>
                   ...
                   <div class="_button-wrapper _full_width">
                    <button id="_form_17_submit" class="_submit btn btn-black btn-form btn-form--w btn-border" type="submit">
                      Enviar
                    </button>
                  </div>
                ...
                <div class="_form-thank-you" style="display:none; color: #fff;">
                </div>
              ...
              <script type="text/javascript">
                window.cfields = {"1":"ciudad","2":"mensaje","4":"acepto_polticas_de_privacidad","10":"utmsource","11":"utmmedium","12":"utmcampaign","16":"utm_group","15":"utm_content","13":"utmterm","14":"referrerurl"};
